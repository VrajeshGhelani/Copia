...
const Card = ({ icon: Icon, title, description, delay = 0 }) => (
    <motion.div
        ...
        className="bg-white p-8 rounded-3xl shadow-soft hover:shadow-premium transition-all duration-300 border border-primary-light flex flex-col items-center text-center space-y-4 group"
    >
        ...
        <h3 className="text-xl font-bold text-primary-dark group-hover:text-primary transition-colors">{title}</h3>
        <p className="text-primary-dark/60 font-medium leading-relaxed">{description}</p>
    </motion.div>
);
            ...
            <div className="max-w-7xl mx-auto space-y-16">
                <div className="text-center space-y-4 max-w-3xl mx-auto">
                    ...
                    <motion.h2
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="text-4xl md:text-5xl font-black text-primary-dark"
                    >
                    ...
                    <motion.p
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="text-lg text-primary-dark/60 font-medium leading-relaxed"
                    >
