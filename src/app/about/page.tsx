    ...
    return (
        <SmoothScroll>
            ...
            <main className="min-h-screen transition-colors duration-700">
                ...
                <section className="py-12 md:py-20 px-6 transition-colors duration-700 overflow-hidden relative">
                    <div className="max-w-4xl mx-auto">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-tight text-gray-900 dark:text-white text-center mb-12 transition-colors duration-700">
