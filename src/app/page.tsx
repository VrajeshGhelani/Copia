  ...
  return (
    <SmoothScroll>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="py-12 md:py-20 px-6 bg-primary-light/5 relative overflow-hidden">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            >
              <span className="inline-block px-8 py-2 bg-primary/10 rounded-full text-primary font-black text-xs tracking-[0.5em] uppercase italic border border-primary/20 shadow-soft">
                The Brand Story
              </span>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 1.5, ease: [0.76, 0, 0.24, 1] }}
              className="flex-1 relative aspect-square w-full max-w-[600px] bg-white rounded-[4rem] shadow-premium overflow-hidden p-8 border border-primary/10"
            >
        ...
        <section className="py-12 md:py-20 px-6 bg-white overflow-hidden" id="products">
          <div className="max-w-7xl mx-auto w-full">
            <div className="text-center max-w-4xl mx-auto mb-16">
              <motion.span
                ...
                viewport={{ once: true }}
                className="inline-block px-8 py-2 bg-primary/10 rounded-full text-primary font-black text-xs tracking-[0.5em] uppercase italic border border-primary/20 shadow-soft"
              >
                Our Hydration Range
              </motion.span>
              <div className="flex flex-col mb-6 mt-6">
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900 mb-2">
                  Essential
                </h2>
              ...
              <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-4 max-w-3xl mx-auto">
